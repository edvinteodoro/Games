...
public class tablero extends JPanel implements ActionListener{
   ...
   @Override
    ...
    private final int blocksize = 24;//<-24
    private final int nrofblocks = 15; //<-15
    ...
    private final short leveldata[] = {
      /*19*/  19, 26, 26, 26, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 22,
        ...
        9, 8, 8, 8, 8, 8, 8, 8, 8, 8, 25, 24, 24, 24, 28//28
    };

    private final int validspeeds[] = {1, 2, 3, 4, 6, 8};
    private final int maxspeed = 20;//6
    ...
    private void initGame() {
        ...
        pacsleft = 2;  //Cantidad de vidas de pacman
        score = 0;
        initLevel();
        nrofghosts = 6; //numero de ghosts
        currentspeed = 3; //velociada de ghosts 3
    }
